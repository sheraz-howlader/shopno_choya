                        ...
                        <div class="dropdown-body text-wrap header-notification-scroll position-relative"
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ url('tenant/backend/images/user/avatar-2.jpg') }}" alt="user-image"
                                ...
                                <li class="list-group-item">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="position-relative text-muted mt-1 mb-2"><br>
                                                <span class="text-truncate"><strong> Jonny aber</strong> invites to join the challenge</span>
                                            </p>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="position-relative text-muted mt-1 mb-2">Lorem Ipsum is simplydummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ url('tenant/backend/images/user/avatar-2.jpg') }}" alt="user-image" class="user-avtar avtar avtar-s">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div class="d-flex">
                                                <div class="flex-grow-1 me-3 position-relative">
                                                    <h5 class="mb-0 text-truncate">Keefe Bond
                ...
                <li class="dropdown pc-h-item header-user-profile">
                    <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
                       role="button" aria-haspopup="false" data-bs-auto-close="outside" aria-expanded="false">
                        <img src="{{ url('tenant/backend/images/user/avatar-2.jpg') }}" alt="user-image" class="user-avtar">
                    </a>
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <a href="#" class="dropdown-item">
                                            ...
                                            <div class="user-group">
                                                <img src="{{ url('tenant/backend/images/user/avatar-2.jpg') }}" alt="user-image" class="avtar">
                                                <img src="{{ url('tenant/backend/images/user/avatar-2.jpg') }}" alt="user-image" class="avtar">
                                                <img src="{{ url('tenant/backend/images/user/avatar-2.jpg') }}" alt="user-image" class="avtar">
                                            </div>
                                        </a>
                                        ...
                                        <div class="dropdown-item">
                                            ...
                                            <div class="form-check form-switch form-check-reverse m-0">
                                                <input class="form-check-input f-18" id="dark-mode" type="checkbox"
                                                       ...
                                                       role="switch" data-cf-modified-6c705b80c5ee6d73b3f92550->
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
